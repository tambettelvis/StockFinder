...
public class Main extends Application {
	...
	public void start(Stage primaryStage) throws Exception {
		initialize();
		//Borderpanel - p�hipaneel, kuhu l�hevad k�ik teised elemendid.
		BorderPane borderPanel = new BorderPane();
		//TopPaneli l�hevad k�ik p�ise(header) elemendid.
		...
		//Keskpaneel jaguneb kaheks(vasak, parem). Parem paneel n�itab aktsia informatsiooni, vasakul on aktsia sisestus.
	...
	/** V�tab aktsia informatsiooni XML failist ning lisab selle listi. */
	...
	/** OnButtonClicked k�sitleb nuppude vajutust. */
